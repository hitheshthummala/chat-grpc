...
func (c *chatServiceClient) JoinChat(ctx context.Context, in *JoinRequest, opts ...grpc.CallOption) (*JoinResponse, error) {
...
func (UnimplementedChatServiceServer) JoinChat(context.Context, *JoinRequest) (*JoinResponse, error) {
...
func _ChatService_JoinChat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).JoinChat(ctx, req.(*JoinRequest))
	}
